...
#ifndef HWCONSTANTS_REV5USB
#define HWCONSTANTS_REV5USB

class HardwareConstantsRev5USB : public HardwareConstants
{
public:
	HardwareConstantsRev5USB(){};
	~HardwareConstantsRev5USB(){};

	uint revision() const { return 5; }
	...
	uint ar_maxlen() const { return 25; }
