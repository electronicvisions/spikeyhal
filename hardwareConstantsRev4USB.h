...
#ifndef HWCONSTANTS_REV4USB
#define HWCONSTANTS_REV4USB

class HardwareConstantsRev4USB : public HardwareConstants
{
public:
	HardwareConstantsRev4USB(){};
	~HardwareConstantsRev4USB(){};
	...
	uint sg_lat2csync() const { return 22; }

	uint sg_latrd2cpreg() const { return 17; }
	...
	uint sg_scmode() const { return 0; }

	uint sg_scdirect0() const { return 1; }

	uint sg_scdirect1() const { return 2; }
	uint sg_scdirect2() const { return 3; }
	uint sg_scdirect3() const { return 4; }

	uint sg_scdelay() const { return 5; }

	uint sg_scsendidle() const { return 6; }

	uint sg_scevtimeout() const { return 7; }

	uint sg_scrxevstat() const { return 8; }

	uint sg_scanamux() const { return 9; }

	uint sg_scphsel() const { return 10; }


	uint sg_scpower_pos() const { return 0; }

	uint sg_scrst_pos() const { return 4; }

	uint sg_sccim_pos() const { return 8; }

	uint sg_scdirectout() const { return 9; }

	uint sg_scplr_pos() const { return 12; }

	uint sg_scvrest_pos() const { return 16; }

	uint sg_scvm_pos() const { return 20; }

	uint sg_scibtest_pos() const { return 24; }


	uint sg_rxd0_phsel_pos() const { return 0; }

	uint sg_rxd1_phsel_pos() const { return 4; }

	uint sg_rxc0_phsel_pos() const { return 8; }

	uint sg_rxc1_phsel_pos() const { return 12; }
	...
	uint sg_sc_syncsw() const { return 8; }

	uint sg_sc_write_full() const { return 27; }
	...
	uint sg_sc_wdataw() const { return sg_ev_cidataw() - 30; }
	...
	uint sg_sb_write_full() const { return 4; }
	...
	uint sg_sc_syncs() const { return 12; }


	uint sg_sc_muxw() const { return 2; }

	uint sg_sc_mux012_pos() const { return 0; } // spikey board v1

	uint sg_sc_mux345_pos() const { return 4; }

	uint sg_sc_mux67_pos() const { return 8; }

	uint sg_sc_mux10m_pos() const { return 0; } // spikey board v2
	...
	// deprecated - only there to be not pure virtual...
